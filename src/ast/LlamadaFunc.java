...
//	llamadaFunc:expresion -> nombre:String  params:expresion*

public class LlamadaFunc extends AbstractExpresion {

	public LlamadaFunc(String nombre, List<Expresion> params) {
		this.nombre = nombre;
		this.params = params;
	...
	public LlamadaFunc(Object nombre, Object params) {
