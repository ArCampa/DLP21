...
//	ifStatement:sentencia -> expr:expresion  ifTrue:sentencia*  ifFalse:sentencia*

public class IfStatement extends AbstractSentencia {

	public IfStatement(Expresion expr, List<Sentencia> ifTrue, List<Sentencia> ifFalse) {
		this.expr = expr;
		this.ifTrue = ifTrue;
	...
	public IfStatement(Object expr, Object ifTrue, Object ifFalse) {
